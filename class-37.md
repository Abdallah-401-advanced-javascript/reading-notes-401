...
----------------------------------
  ...
  * The **Combined Reducers** helper function turns an object whose values are different reducing functions into a single reducing function you can pass to createStore .
  ...
  * **Combined Reducers** is this more work/boilerplate.
  * **Combined Reducers** allow you decouple logic.
  * In **Combined Reducers** behavior needs to be well understood or it’ll cause unintended consequences.
